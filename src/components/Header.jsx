    ...
    <>
      ...
      <header className="flex items-center justify-between px-8 py-5 text-[12px] desktop:grid desktop:grid-cols-3">
        ...
        <button
          ...
          className="-m-3 p-3 text-[14px] uppercase transition-opacity hover:opacity-60 desktop:hidden"
        >
          Menu
        </button>
      </header>
      ...
      >
        <div className="flex items-center justify-between px-8 py-5 text-[12px]">
          ...
          <button
            ...
            className="-m-3 p-3 text-[14px] uppercase transition-opacity hover:opacity-60"
          >
            Close
          </button>
        </div>
