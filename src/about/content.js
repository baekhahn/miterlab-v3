...
export default {
  // Korean companion to the intro statement (site.about), shown in the
  // right columns beside the headline.
  introKr: [
    '정교하게 맞물리는 45도 마이터처럼, 아이디어와 기술을 세심하게 이어 오래 남는 경험을 만듭니다.',
  ],
  ...
  paras: [
    ...
    'We believe that exceptional photography is all about the finer details. From selecting the perfect lighting and angles to ensuring the ideal backdrop, we meticulously plan every aspect of the shoot. This commitment to detail helps us deliver photos with clarity, depth, and precision, ensuring each image meets our high standards and beautifully captures the moment’s essence.',
    'At Miterlab, we see every session as an opportunity to tell a unique story. Rather than just snapping pictures, we aim to create a visual narrative that brings out the emotions, atmosphere, and nuances of each scene. This storytelling approach transforms everyday moments into captivating works of art that you’ll treasure for years to come.',
    'These accolades underscore our dedication to capturing moments that truly resonate.',
    'Interested in working with me?',
    'Copyrights @ 2026, MITERLAB',
  ],
}
